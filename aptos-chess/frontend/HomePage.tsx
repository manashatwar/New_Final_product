...
Experience the thrill of competitive chess in a modern, blockchain-powered ecosystem. Compete, win, and earn crypto rewards in a secure and seamless environment.
          ...
          <section className="container mx-auto mt-24 px-5">
            <h2 className="text-4xl font-extrabold text-almond mb-8">Key Features for Chess Champions</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <ul className="text-gray-600">
                 ...
                 <li>Join us on this journey to revolutionize competitive chess. From secure blockchain implementation to advanced chess features, the future of gaming is here.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="py-12 mt-24">
            <div className="container mx-auto text-center">
              ...
              <p className="text-white">Be the Pioneer in Crypto Chess Tournaments!</p>
          ...
          <section className="container mx-auto mt-16 px-5">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-left">
                <h2 className="text-2xl font-bold text-almond mb-4">Subscribe to our newsletter to receive the latest updates on tournaments, new features, and exciting opportunities to earn crypto rewards</h2>
