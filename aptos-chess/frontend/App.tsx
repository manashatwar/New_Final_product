...
//       const [selectedDay, setSelectedMonth] = useState('');
//       const [selectedMonth, setSelectedYear] = useState('');
//       const [selectedYear, setSelectedDay] = useState('');
...
//       const selectedDate = selectedDay && selectedMonth && selectedYear ? `${selectedDay}-${selectedMonth}-${selectedYear}` : '';
...
//                 <button className="bg-beaver px-4 py-1.5 rounded text-white-smoke">CASINO</button>
//                 <button className="bg-walnut-brown px-4 py-1.5 rounded text-gray-300">SPORTS</button>
//               </div>
//              </div>
//             <div className="flex items-center space-x-4">
//             <Header />
...
//   )}
// </span>
// <span>  <button className="px-4 py-1.5 text-gray-300" onClick={openSignIn}>SignIn</button></span>
...
//                   <input type={passwordVisible ? "text" : "password"} className="w-full bg-black rounded p-3 text-white-smoke pr-10" />
//                 </div>
//                 <button className="w-full bg-beaver px-4 py-2 rounded text-white-smoke mb-6 transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-[#00640033]">Sign In</button>
